...
int main()
{
    ...
    while (1) {
        std::cout << "0. Exit\n"
            << "1.Print tree(нарисовать дерево)\n"
            << "2.Inorder(центрированный порядок)\n"
            << "3.Preorder(прямой порядок)\n"
            << "4.Postorder(обратный обход)\n"
            << "5.Contains value(удаление)\n"
            << "6.Get maximum\n"
            << "7.Get minimum\n"
            << "8.Add value(добавление)\n"
            << "Enter: ";
        int t;
        std::cin >> t;
        system("cls");
